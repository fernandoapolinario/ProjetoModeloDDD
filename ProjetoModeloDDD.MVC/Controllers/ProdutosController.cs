...
namespace ProjetoModeloDDD.MVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        private readonly IEmpresaService _empresaApp;
        private readonly IClienteAppService _clienteApp;

        public ProdutosController(IProdutoAppService produtoApp, IEmpresaService empresaApp, IClienteAppService clienteApp)
        {
